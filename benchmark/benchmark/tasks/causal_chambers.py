...
class WindTunnelTask(UnivariateCRPSTask):
    ...
    def random_instance(self, downsample: str ='1s'):
        ...
        self.covariates = self.verbalize_covariate(observations.iloc[window.history_start:window.time_end])
...
class SpeedFromLoad(WindTunnelTask):
    ...
    def __init__(self, seed: int = None, fixed_config: dict = None, datadir: str = '/mnt/starcaster/data/causal_chambers/'):
